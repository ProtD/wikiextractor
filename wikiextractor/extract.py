...
# tyhle šablony se budou ignorovat
discardTemplates = ['šablona:' + x for x in [
    'podrobně', 'různé významy', 'redirect', 'překlad', 'rozcestník', 'neověřeno', 'upravit',
    'upravit část', 'možná hledáte', 'bibliografie', 'cedule', 'nk čr', 'infobox - fotbalová sezóna',
...
class Extractor():
    ...
    def expandTemplate(self, body):
        ...
        if title.lower() in discardTemplates:
            return ''
